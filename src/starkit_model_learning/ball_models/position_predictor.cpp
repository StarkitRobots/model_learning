...
PositionPredictor::Input::Input(const Input& other)
  : ball_pos(other.ball_pos), ball_speed(other.ball_speed), prediction_duration(other.prediction_duration)
{
}

std::unique_ptr<starkit_model_learning::Input> PositionPredictor::Input::clone() const
{
