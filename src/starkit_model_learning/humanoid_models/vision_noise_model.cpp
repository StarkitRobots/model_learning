...
VisionNoiseModel::VisionNoiseModel(const VisionNoiseModel& other) : px_stddev(other.px_stddev)
{
}
...
void VisionNoiseModel::fromJson(const Json::Value& v, const std::string& dir_name)
{
  (void)dir_name;
